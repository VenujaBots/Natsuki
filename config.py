...
def get_user_list(config, key):
    with open("{}/MaxBot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    TOKEN = "2143873439:AAF4v4I1m6y38KpkDFZpmSLKPHZW_0UKHa8"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    CASH_API_KEY = (
        "NMATP3T0N6WOIEBB"  # Get your API key from https://www.alphavantage.co/support/#api-key
    )
